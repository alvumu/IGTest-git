...
* ^url = "http://testSK.org/StructureDefinition/encounter-provider-provenance" // Example URL
* ^version = "1.0.0"
...
Instance: ExampleEncounterProviderProvenance
InstanceOf: EncounterProviderProvenanceProfile
* target = Reference(StrokeEncounterExample) // Link to the specific encounter
* agent[ProviderOrg].who = Reference(ExampleOrganization) // Link to the provider organization
* agent[ProviderOrg].who.display = "Example Healthcare Organization" // Example display name
